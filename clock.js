...
function settime(){
    ...
    var hour=new Date().getHours();
     ...
     if(x==hour)
    {
         document.getElementById("imgcontainer").style.backgroundImage="url(wakeup_image.png)";
...
function settime2(){
    ...
    var hour=new Date().getHours();
     ...
     if(x==hour)
    {
         document.getElementById("imgcontainer").style.backgroundImage="url(lunch_image.png)";
...
function settime3(){
    ...
    var hour=new Date().getHours();
     ...
     if(x==hour)
    {
        document.getElementById("imgcontainer").style.backgroundImage="url(goodnight_image.png)";
...
function abc(){
    ...
    if(x=='Default'){
        ...
        item1.innerText="Set Wake up Time: " +' 12AM-1AM';
    }
    else if(x==11){
        item1.innerText="Set Wake up Time: " + x+'AM'   +'-' + (++x) +'PM';
    }
    else if(x==12){
        item1.innerText="Set Wake up Time: " +' 12PM-1PM';
    }
    else if(x<11)
    {
    ...
    if(y=='Default'){
        ...
        item2.innerText="Set lunch Time: " +' 12AM-1AM';
    }
    else if(y==11){
        item2.innerText="Set lunch Time: " + y+'AM'   +'-' + (++y) +'PM';
    }
    else if(y==12){
        item2.innerText="Set lunch Time: " +' 12PM-1PM';
    }
    else if(y<11)
    {
    ...
    if(z=='Default'){
        ...
        item3.innerText="Set Sleep Time: " +' 12AM-1AM';
    }
    else if(z==11){
        item3.innerText="Set Sleep Time: " + z+'AM'   +'-' + (++z) +'PM';
    }
    else if(z==12){
        item3.innerText="Set Sleep Time: " +' 12PM-1PM';
    }
    else if(z<11)
    {
